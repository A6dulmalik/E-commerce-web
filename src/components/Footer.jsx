  ...
  return (
    <>
      <div className=" bg-black h-[300px] w-full">
        <div className="flex flex-wrap justify-between text-white border-b border-gray-800 m-auto px-20 py-10">
          <div className="">
            <p className="text-2xl font-semibold mb-3">Exclusive</p>
            <div>
              <p className="text-xl">Subscribe</p>
              <span className="my-5">Get 10% off your first order</span>
